...
# Carpeta de origen (Fotos originales)
ORIGINAL_DATASET_DIR = os.path.abspath(os.path.join(BASE_DIR, '..', 'dataset'))

# Carpeta de destino (Caras recortadas)
...
# ==========================================
# 1. FUNCIÓN DE LIMPIEZA ROBUSTA (ANTI-CRASH)
# ==========================================
...
# ==========================================
# 2. CARGA DE DATOS Y MODELO MEJORADO
# ==========================================
...
# CAMBIO 1: Global Average Pooling (Mejor que AveragePooling2D 7x7)
headModel = GlobalAveragePooling2D()(headModel)
# CAMBIO 2: Más neuronas (1024) para mayor capacidad de aprendizaje
...
# --- GUARDAR ---
model_path = os.path.join(MODEL_DIR, 'face_classifier_final.h5')
